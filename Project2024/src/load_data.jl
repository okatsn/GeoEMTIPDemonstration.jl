...
function load_all_trials(::PhaseTestEQK)
    ...
    df24a = CWBProjectSummaryDatasets.dataset("Summary_JointStation-A19-4Dr", "PhaseTestEQK_3yr_173d_A19")
    df24 = CWBProjectSummaryDatasets.dataset("Summary_JointStation-J28-1qx", "PhaseTestEQK_3yr_173d_J28")
